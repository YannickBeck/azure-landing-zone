...
add_table(doc,
    ...
    [
        ...
        ["alz-platform-connectivity",      "Connectivity",                       "alz-platform",      "Hub-Netzwerk, Azure Firewall, DNS, Logging – Connectivity Sub"],
...
add_body(doc, "Gelten für alle Plattform-Subscriptions (connectivity).", size=10)
add_table(doc,
    ["Assignment-Name", "Typ", "Effekt"],
    [
...
doc.add_heading("2.7 alz-sandbox – 1 Assignment", level=2)
add_table(doc,
    ["Assignment-Name", "Typ", "Effekt"],
...
add_table(doc,
    ...
    [
        ["Stufe 1",  "templates/core/governance/mgmt-groups/int-root/main.bicep",
         "alz MG + alle 7 Kind-MGs",                                            "avm/ptn/alz/empty:0.3.6"],
        ["Stufe 2",  "templates/core/governance/mgmt-groups/landingzones/main.bicep",
         "alz-landingzones Sub-MGs (corp)",                                      "Az. Management Module"],
        ...
        ["Stufe 10-17","(Policy Assignment Templates)",
         "118 Policy Assignments auf 7 MG-Ebenen",                              "avm/ptn/alz/empty:0.3.6"],
...
add_body(doc,
    "Kunden-Minimal (~€765/Monat): 1 Hub in Germany West Central, Firewall Standard aktiv. "
    "Bastion, VPN Gateway und DNS Private Resolver zurückgestellt – Subnetze reserviert, jederzeit aktivierbar.", size=10)
add_table(doc,
    ...
    [
        ...
        ["Azure Bastion Standard", "bas-alz-germanywestcentral",      "avm/res/network/bastion-host",             "10.0.0.64/26", "Zurückgestellt"],
        ["VPN Gateway (VpnGw1AZ)", "vgw-alz-germanywestcentral",     "avm/res/network/virtual-network-gateway",  "10.0.0.128/27","Zurückgestellt"],
        ["DNS Private Resolver",   "dnspr-alz-germanywestcentral",    "avm/res/network/dns-resolver",             "10.0.0.160/28","Zurückgestellt"],
...
add_table(doc,
    ...
    [
        ["templates/core/subscription-vending/main.bicep",
         "Subscription → korrekte MG (corp); Spoke VNet; VNet-Peering zum Hub; Route Table; NSG; RBAC",
...
add_body(doc,
    ...
    "Region-Kürzel: gwe = Germany West Central."
)
...
add_body(doc,
    ...
    "für die produktive Landing Zone (Germany West Central – einzige Region im Kunden-Minimal-Setup).",
    size=10
)
add_table(doc,
    ...
    [
        ...
        # Hub Networking GWC – Zurückgestellt (Subnetz reserviert)
        ["bas-alz-germanywestcentral",        "Azure Bastion (Zurückgestellt)",        "GWC", "rg-alz-conn-germanywestcentral"],
        ["vpngw-alz-germanywestcentral",      "VPN Gateway (Zurückgestellt)",          "GWC", "rg-alz-conn-germanywestcentral"],
        ["dnspr-alz-germanywestcentral",      "DNS Private Resolver (Zurückgestellt)", "GWC", "rg-alz-conn-germanywestcentral"],
        # DNS
...
add_table(doc,
    ...
    [
        ...
        ["alz (+ 7 Kind-MGs)",                "Management Groups (8)",            "Tenant Root – identisch zu Prod"],
        # Resource Groups
